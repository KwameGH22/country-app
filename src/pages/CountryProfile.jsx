...
import { Link, useLoaderData, Navigate, redirect } from "react-router-dom";
import { getCountries, getCountry } from "../apiCall";
  ...
  return (
    <div className="container grid gap-12 py-12 items-start ">
      <Link to={"/"} className="text-black font-light w-max">
        <button
          className='px-4 py-2  bg-white rounded-sm shadow-lg dark:bg-[#2B3844] dark:text-[#FFFFFF] '
        >
          ← Back
        </button>
      </Link>
